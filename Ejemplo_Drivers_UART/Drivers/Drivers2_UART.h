...
#ifndef DRIVERS_DRIVERS2_UART_H_
#define DRIVERS_DRIVERS2_UART_H_

#include "Drivers2_UART_config.h"
#include <stdbool.h>
...
#define MAIN_UART (uint32_t)(EUSCI_A0_UART)
...
// Inicialización y configuración de la UART version 2 (UTILIZANDO ESCRITURA EN LOS REGISTROS CTLW0).
void UART_Inicializar2(void);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
#endif /* DRIVERS_DRIVERS2_UART_H_ */
